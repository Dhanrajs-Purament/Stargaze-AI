...
> **Status:** Draft | **Author:** Senior Android Engineer | **Date:** 2026-07-02
...
| Area | Issue | Severity |
|------|-------|----------|
| **Theme** | Generic dark theme lacks cinematic depth; no subtle space imagery/gradients | Medium |
| **Typography** | Flat styles, no typographic hierarchy or semantic use of weight | Medium |
| **Animations** | Very minimal animation; no transitions, entrance effects, or micro-interactions | High |
| **Onboarding** | Static, no visual storytelling; emoji-only branding instead of high-quality assets | High |
| **Main Shell** | Bottom nav has no pressed states; sheets feel abrupt | Medium |
| **Sky Map** | Stars are static; no shooting star effect, better twinkle, or constellation animations | Medium |
| **Typography** | No shimmer loading, animated text reveals, or FAB expansions | High |
| **Interaction** | No haptic feedback or touch-ripple effects beyond default | Medium |
| **Accessibility** | Needs content descriptions, proper touch targets, high-contrast mode | High |
| **Onboarding** | The Create Account / onboarding flow has known errors per TRD | High |
| **Component System** | No reusable animation system or shared transition definitions | Medium |
...
2. **Performance:**
   ...
   - Ensure the `withFrameMillis` loop and `recomposeSnapshot` are optimized to avoid unnecessary recompositions.
